    ...
    <footer id="footer">
        ...
        <div class="container d-md-flex py-4">
            ...
            <div class="me-md-auto text-center text-md-start">
                <div class="copyright">
                    &copy; Copyright <strong><span>Royal Lucky (10)</span></strong>. All Rights Reserved
                </div>
                {{-- <div class="credits">
    ...
    <script src="{{ url('assets/js/homebootstrap.bundle.min.js') }}"></script>
    ...
    <script src="{{ url('assets/js/homemain.js') }}"></script>
