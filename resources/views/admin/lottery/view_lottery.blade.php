                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="{{$lottery->lottery_name}}" id="name" placeholder="Enter lottery name"
                                name="lottery_name">
                                @error('lottery_name')
                    ...
                    <div class="row mt-3">
                        <div class="col-md-12">
                            ...
                            <input id="x" type="hidden" name="description" value="{{$lottery->description}}">
                    ...
                    <div class="row mt-3">
                        ...
                        <img src="{{$lottery->getFirstMediaUrl('lottery_image')}}" style="max-width: 200px"/>
